...
public class Vision extends SubsystemBase {
    ...
    public void periodic() {
         ...
         * cameraFront.getEstimationStdDevs() != null ?
         * cameraFront.getEstimationStdDevs().get(0, 0) : "null",
         * false);
         * m_elastic.put("back camera std",
         * cameraBack.getEstimationStdDevs() != null ?
         * cameraBack.getEstimationStdDevs().toString() : "null",
         * false);
         */
